...
myawesomemenu = {
   ...
   { "reboot", power.reboot_dialog },
   { "power off", power.poweroff_dialog }
}

mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "open terminal", terminal },
                                    { "internet", browser, beautiful.browser_icon },
...
-- {{{ Wibar
-- Firefox button
firefox_button = awful.widget.button({ image = beautiful.browser_dark_icon })
firefox_button:buttons(awful.util.table.join(
   awful.button({ }, 1, function () awful.util.spawn(browser) end)
))

-- Sublime button
editor_button = awful.widget.button({ image = beautiful.editor_dark_icon })
editor_button:buttons(awful.util.table.join(
   awful.button({ }, 1, function () awful.util.spawn(editor) end)
))

-- File manager button
folder_button = awful.widget.button({ image = beautiful.folder_icon })
folder_button:buttons(awful.util.table.join(
...
--separator:set_text(" | ")
separator:set_markup("<b><span color='green'> :: </span></b>")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Main", "Web", "Edit", "All", "Other" }, s, awful.layout.layouts[2])
